...
Machine-specific local paths for the ArduPilot checkout should not be committed. Keep those in the local-only skill at `.agents/skills/local_context/SKILL.md`, which is ignored by git.
